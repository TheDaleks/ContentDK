...
It is now possible to explain the paradox of Bitcoin and the reasons that it has often been analyzed inadequately by Austrians. In order to analyze bitcoins properly, it is necessary to use only the cold, hard logic of the regression theorem rather than let one's love of gold interfere.
...
This article provides only a partial explanation for the original value of Bitcoins and there was an important question that it left unanswered which I can now answer. The problem with the first use of any good as a medium of exchange is that it must be sold after it is bought, thus there must be a reason to expect future demand. Mises concluded that this good must have some value other than as a medium of exchange, although this is not actually required by the regression theorem. The problem is that people must believe that other people are demanding a good for use as a medium of exchange before it has ever been used as a medium of exchange. It is much more obvious to presume that a good was initially demanded as a medium of exchange because it was known to be demanded for some other reason. If a good were to be initially demanded as a medium of exchange before it had been demanded for other reasons, people would all have to start acquiring it at the same time, expecting other people to want to acquire it later, knowing no particular reason for them to do so now. Bitcoin gets around this with its [hashpower signalling system](https://bitcoinfiles.org/t/0c9544cf8650794d0221a0b11fec45ed19409e6deef9b3eeeea7ee956cdde7af). Proof-of-work means that people can actually see that others are demanding Bitcoin. They can see that others are spending energy in order to get some. Thus, they can see that Bitcoin is demanded, although hashpower does not tell them why. It is reasonable to presume that the demand is as a medium of exchange, since there is apparently no other possible reason to demand it. 

By signalling his demand for Bitcoin, Satoshi could expect other people would be interested in joining him. They would know that they could get work out of him by paying Bitcoin. Thus, it would be reasonable for them to demand Bitcoin as a medium of exchange. Thus, Bitcoin does not violate the regression theorem even though it has no function other than as a medium of exchange. 
...
[^2] Please see Šurda, P., ["Economics of Bitcoin: is Bitcoin an Alternative to Fiat Currencies and Gold?"](b://648dbf549479eedf6d6e2f64609169ac0a8c799479516e747a1dd14cc083ae07), 2012, pp. 38-41 for Šurda's discussion of the regression theorem, upon which I have relied quite heavily.

[^3] This argument has emphasized by other pro-Bitcoin Austrians. See [Šurda, 2012](b://648dbf549479eedf6d6e2f64609169ac0a8c799479516e747a1dd14cc083ae07), Graf, K., ["Bitcoins, the Regression Theorem, and that Curious but Unthreatening Empirical World"](http://konradsgraf.com/blog1/2013/2/27/in-depth-bitcoins-the-regression-theorem-and-that-curious-bu.html), 23 Feb 2013, and Selgin, G., ["Bitcoin"](https://www.alt-m.org/2013/04/22/bitcoin/), 22 Apr 2013.

[^4] See [Šurda, 2012](b://648dbf549479eedf6d6e2f64609169ac0a8c799479516e747a1dd14cc083ae07), pp. 41-42.
...
[^10] [Šurda, 2012](b://648dbf549479eedf6d6e2f64609169ac0a8c799479516e747a1dd14cc083ae07), pg. 42.
